...
docker-compose -f docker-compose.yml up -d orderer.example.com couchdb0.org1.example.com couchdb0.org2.example.com  couchdb0.org3.example.com ca.org1.example.com ca.org2.example.com ca.org3.example.com peer0.org1.example.com peer0.org2.example.com peer0.org3.example.com
...
docker exec peer0.org1.example.com mv mychannel.block /etc/hyperledger/configtx
sleep 5
